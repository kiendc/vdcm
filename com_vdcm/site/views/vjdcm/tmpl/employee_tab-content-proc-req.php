<br>
<table id="proc-reqs-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
    <thead>
        <tr>
            <?php
                echo '<th class="dt-body-center"><input type="checkbox" name="select-all"></th>';
